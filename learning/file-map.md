...
- server.js — known (2026-07-27) — the Express server, now serving only public/ (fixed a real source-code-exposure bug on 2026-07-30) → [[express-backend]] [[express-routes]] [[localhost-and-ports]] [[nodejs-runtime]] [[node-path-module]]
